...
## Some Terminology before PSA


---
class: middle

## What do me mean by "causal inference"? (1)
...
## What do me mean by "causal inference"? (2)
...
## Conditionging on covariates


- So we have some statistical variable selection procedure. 

- Transfution, and length of stay in hospital are on the causal pathway from X to Y

- After adjustment, we have an estimated conditional logOR of -0.24 (95% CI -0.41, -0.07)


---
class: middle

## But, the conditional logOR cannot answer our question: 
...
## Causal Estimands for a binary outcome
...
- This means we are 100% sure that there is **no other unmeasured confounding**.
